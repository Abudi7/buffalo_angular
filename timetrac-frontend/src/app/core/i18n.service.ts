...
const DICTS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'analytics.averageHours': 'Avg Hours/Day',
    'analytics.activeProjects': 'Active Projects',
    'analytics.chartComingSoon': 'Charts coming soon!',
    'analytics.description': 'View your time tracking insights and analytics',
  ...
  ar: {
    ...
    'analytics.averageHours': 'متوسط الساعات/يوم',
    'analytics.activeProjects': 'المشاريع النشطة',
    'analytics.chartComingSoon': 'الرسوم البيانية قادمة قريباً!',
    'analytics.description': 'عرض رؤى وإحصائيات تتبع الوقت',
  ...
  de: {
    ...
    'analytics.averageHours': 'Ø Stunden/Tag',
    'analytics.activeProjects': 'Aktive Projekte',
    'analytics.chartComingSoon': 'Diagramme kommen bald!',
    'analytics.description': 'Zeiterfassungs-Insights und Analysen anzeigen',
